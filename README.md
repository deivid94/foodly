...
# PROJETO FOODLY 
 ...
 - [X] Construir home, sobre e  receitas
 - [X] Estilizar conforme solicitado
  
  ## Obrigatoriedades
 - [X] Na pagina receitas quando clicado no cards de receitas
 deve abrir um modal sobreponto a pagina receitas com um fundo branco.
 - [X] No modal content deve ser exibido, a imgem da receita com descricao
 e autor
 - [X] todos eventos no modal devem ser controlados via javascript.
